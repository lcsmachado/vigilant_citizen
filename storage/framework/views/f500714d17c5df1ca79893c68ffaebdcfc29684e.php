...
<?php $__env->startSection('content'); ?>
    <div class="row" style="margin-top: 2rem;">
        <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9 col-md-offset-1 col-lg-offset-1">
            ...
            <a href="<?php echo e(route('admin.trash')); ?>" type="button" class="btn btn-danger btn-flat pull-right" style="margin-bottom: 10px;">
                            ...
                            <?php $__currentLoopData = $admins->all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $admin): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="<?php echo e(route('admin.edit',$admin->id)); ?>" type="button" class="btn btn-primary btn-flat">Editar</a>
                                        <a href="<?php echo e(route('admin.show',$admin->id)); ?>" type="button" class="btn btn-danger btn-flat">Visualizar</a>
                                    </td>
                                </tr>

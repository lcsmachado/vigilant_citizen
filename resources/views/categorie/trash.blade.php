                            ...
                            @foreach($categories->all() as $categorie)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="{{route('categorie.restore',$categorie->id)}}" type="button" class="btn btn-primary btn-flat">Restaurar</a>
                                        <a href="{{route('categorie.showRes',$categorie->id)}}" type="button" class="btn btn-danger btn-flat">Visualizar</a>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
